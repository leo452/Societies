...
ActiveRecord::Schema.define(version: 20161003155109) do
  ...
  create_table "client_courses", force: :cascade do |t|
    t.integer  "client_id"
    t.integer  "course_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  add_index "client_courses", ["client_id"], name: "index_client_courses_on_client_id"
  add_index "client_courses", ["course_id"], name: "index_client_courses_on_course_id"
  ...
  create_table "courses", force: :cascade do |t|
    ...
    t.float    "valor_total"
    t.integer  "id_category_id"
    t.datetime "created_at",     null: false
    t.datetime "updated_at",     null: false
    t.integer  "user_id"
  end

  add_index "courses", ["id_category_id"], name: "index_courses_on_id_category_id"
