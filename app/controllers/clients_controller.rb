class ClientsController < ApplicationController
 ...
 # def membership
  ...
  def client_params
    params.require(:client).permit(:tipo_documento, :documento, :nombre, :apellido, :telefono, :direccion, :pais, :ciudad, :email, :society_id, :valor_pago, :formaDePago, :soporte, :periodicidad)
  end
